                ...
                <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form  action="{{ route('reportFilter.list') }}" method="get" class="mb-3 justify-content-end" style="display: flex; gap: 8px">
                                ...
                                <a href="{{ route('export-xlsx',['department_id'=>session('selected_department_id'),'month'=>$data['month']]) }}" type="submit" class="btn btn-primary col-2 search">Արտահանել XLSX</a>
                            </form>
                            <!-- Bordered Table -->
